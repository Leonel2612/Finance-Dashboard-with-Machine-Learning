                    ...
                    >
                        <defs>
                            ...
                            <linearGradient id="colorExpenses" x1="0" y1="0" x2="0" y2="1">
                                ...
                                <stop offset="5%"  
                                stopColor={palette.red.main} stopOpacity={0.5}/>
                                <stop offset="95%"  stopColor={palette.red.light} stopOpacity={0}/>
                            </linearGradient>
                        </defs>
                        ...
                        <Area type="monotone" dot={true} dataKey="revenue" 
                        stroke={palette.primary.main} 
                        fillOpacity={1} fill='url(#colorRevenue)' />
                        <Area type="monotone" dot={true} dataKey="expenses" stroke={palette.red.main} fillOpacity={1} fill='url(#colorExpenses)' />
                    </AreaChart>
                </ResponsiveContainer>
            </DashboardBox>
