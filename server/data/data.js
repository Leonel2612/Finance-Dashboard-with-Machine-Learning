...
const generateMonthlyData = () => {
  ...
  month.forEach(month=>{  
    const revenue = parseFloat((Math.random()*(23000 - 16000)+ 16000).toFixed(2))
    const operationalExpenses = parseFloat((Math.random()*(9500 - 5000) +5000).toFixed(2));
    const nonOperationalExpenses = parseFloat((Math.random()*(9500 - 5000) +5000).toFixed(2));
    const expenses = operationalExpenses + nonOperationalExpenses
...
const generateDailyData = () =>{
    ...
    const dates=generateDateRange(new Date(2022,0,2), new Date(2023,0,1))
    dates.forEach(dateTime=>{
        const revenue = parseFloat((Math.random()*(1600-1200)+1200).toFixed(2)) 
        const expenses = parseFloat((Math.random()*(800-500)+500).toFixed(2))
